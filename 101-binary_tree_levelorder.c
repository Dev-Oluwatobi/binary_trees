 ...
 *@tree: parameter to the root node of the tree to measure the height.
 * Return: if tree is NULL, function = 0.
 */
...
/**
 * print_at_level - Func that print node.
...
/**
 * binary_tree_levelorder - Func that goes through a binary tree in level-order traversal
